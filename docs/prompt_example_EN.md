...
The Jupyter service starts in the project path and connects to the Notebook file using a relative path. The Jupyter MCP Server service connection parameters are as follows:
